...
class _OnlineGamePageState extends ConsumerState<OnlineGamePage> {
  ...
  Widget build(BuildContext context) {
    ...
    // --- 손패 월별 정렬 ---
    final sortedHand = List<HwatooCard>.from(gs.playerHands[myIndex])
      ..sort((a, b) {
    ...
    if (onlineState.isMyTurn && gs.phase == GamePhase.play) {
            ...
            Column(
              children: [
                ...
                _sectionLabel(
                  ...
                  isActive: onlineState.isMyTurn && gs.phase == GamePhase.play,
                ),
                Padding(
                  padding:
